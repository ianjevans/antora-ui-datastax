...
:hide-uri-scheme:
// Project URLs:
:url-project: https://github.com/ianjevans/antora-ui-datastax
:url-preview:
...
This branch of the repository is a custom version of the {url-antora-default-ui}[Antora Default UI], for the Antora version 
of the Apache Cassandra open source documentation. If you want to make changes, create a "feature" branch off of _oss_, make the required changes, and then create a pull request (PR) against the _oss_ branch. If the PR is accepted and merged, a new `ui-bundle.zip` package file will be created and published.
